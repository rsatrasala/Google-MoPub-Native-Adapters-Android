...
public class MoPubNativeAppInstallAdMapper extends NativeAppInstallAdMapper {
    ...
    public static final int DEFAULT_MOPUB_PRIVACY_ICON_SIZE_PX = 100;
    ...
    public void trackView(View view) {
        ...
        if (overlayView instanceof FrameLayout) {
            ...
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(DEFAULT_MOPUB_PRIVACY_ICON_SIZE_PX,DEFAULT_MOPUB_PRIVACY_ICON_SIZE_PX);
